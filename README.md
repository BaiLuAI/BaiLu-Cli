...
🌐 **官網：[BaiLu AI](https://bailucode.com/)**
...
完整文档已分类整理到 [`docs/`](./docs/) 目录：

- **📖 [使用指南](./docs/guides/)** - 上下文记忆、依赖分析、错误恢复等功能指南
- **💡 [使用示例](./docs/examples/)** - 代码审查、任务规划等实际案例
- **🛠️ [开发文档](./docs/development/)** - Agent 架构、调试指南、AI 改进计划
- **✨ [功能说明](./docs/features/)** - 完整功能列表和能力说明
- **📋 [版本历史](./docs/versions/)** - 更新日志和各版本摘要

👉 查看 [文档索引](./docs/README.md) 了解完整文档结构
